...
const sections = [
  {
    ...
    body: [
      ...
      <>《FitMeet 隐私政策》现行版本为 1.0，更新及生效日期为 2026-07-29。你可以<Link href="/privacy">阅读现行文本</Link>，或打开<Link href="/legal/versions/privacy-1.0">版本 1.0 固定快照</Link>。</>,
  ...
  },
  {
    ...
    body: [
      ...
      "当前 1.0 是首个正式公开版本，因此没有早于 1.0 的已废止版本。未来版本生效后，本页会同时标明现行版本与已失效版本的适用期间。",
    ],
  },
  {
    index: "03",
